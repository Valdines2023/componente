...
uses
   ...
   db, dbtables, TsGrid, TsDbGrid, TsPrintGrid, tsPrintDbGrid, osAdvDbGrid;
...
begin
  if (forGrid is TtsGrid) or
     (forGrid is TosAdvDbGrid) then
...
begin
  ...
  else if (forGrid is TosAdvDbGrid) then
     PreviewUnboundGrid(TtsGrid(forGrid))
  else
...
begin
  ...
  fmPrintDbGrid.ModalPreview := Self.ModalPreview;
...
begin
  ...
  fmPrintGrid.ModalPreview := Self.ModalPreview;
