...
type
    ...
    protected
        ...
        function  GetMaxDate: TDate; virtual; abstract;
        procedure SetMaxDate(Value: TDate); virtual; abstract;
        function  GetMinDate: TDate; virtual; abstract;
        procedure SetMinDate(Value: TDate); virtual; abstract;
