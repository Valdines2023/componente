...
type
    ...
    TtsDateTimeSpinType = (dtsIncrYear, dtsDecrYear, dtsIncrTime, dtsDecrTime, dtsIncrHour, dtsDecrHour, dtsIncrMin, dtsDecrMin);
    ...
    protected
        ...
        procedure butOkMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
        procedure butCancelMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
        ...
        procedure SetTimeControl(Control : TEdit);
        procedure DoSelect;
        procedure DoCancel;
...
begin
    ...
    FButOK := TButton.Create(Self);
    FButCancel := TButton.Create(Self);
    FBevel := TBevel.Create(Self);

    FUpDownHour := TUpDown.Create(FPnlTime);
    FUpDownHour.Max := 9000;
    FUpDownHour.Position := 5000;
    FUpDownHour.Orientation := udHorizontal;
    FUpDownMin := TUpDown.Create(FPnlTime);
    FUpDownMin.Max := 9000;
    FUpDownMin.Position := 5000;
    FUpDownMin.Orientation := udHorizontal;
    FUpDownSec := TUpDown.Create(FPnlTime);
    FUpDownSec.Max := 9000;
    FUpDownSec.Position := 5000;
    FUpDownSec.Orientation := udHorizontal;
    FUpDownAMPM := TUpDown.Create(FPnlTime);
    FUpDownAMPM.Max := 9000;
    FUpDownAMPM.Position := 5000;
    FUpDownAMPM.Orientation := udHorizontal;
    ...
    FUpDownHour.Parent := FPnlTime;
    FUpDownMin.Parent := FPnlTime;
    FUpDownSec.Parent := FPnlTime;
    FUpDownAMPM.Parent := FPnlTime;
    ...
    FUpDownYear  := TUpDown.Create(FPnlDate);
    FUpDownYear.Max := 9000;
    FUpDownYear.Position := 5000;
    FUpDownYear.Orientation := udVertical;
...
begin
    ...
    FUpDownYear.OnClick := UpDownYearClick;
    ...
    FComboMonth.Col[1].Combo.ComboGrid.Rows := 12;
    FComboMonth.Col[1].Combo.ComboGrid.Cols := 1;
    FComboMonth.Col[1].Combo.DropDownRows := 8;
    ...
    FComboMonth.Col[1].Combo.ComboGrid.Width := FComboMonth.Width;
    FComboMonth.Col[1].Combo.ComboGrid.SelectionType := sltColor;
    FComboMonth.Col[1].Combo.ComboGrid.GridLines := glNone;
    FComboMonth.Col[1].Combo.ComboGrid.VertAlignment := vtaCenter;
    ...
    FUpDownHour.OnClick := UpDownTimeClick;
    FUpDownMin.OnClick  := UpDownTimeClick;
    FUpDownSec.OnClick  := UpDownTimeClick;
    FUpDownAMPM.OnClick := UpDownTimeClick;
    ...
    FButOk.OnMouseUp := butOkMouseUp;

    FButCancel.Visible := False;
    FButCancel.ParentFont := False;
    FButCancel.OnMouseUp := butCancelMouseUp;
...
begin
    FComboMonth.Cell[1, 1] := FComboMonth.Col[1].Combo.ComboGrid.Cell[1, FDisplayMonth];
...
begin
    ...
    FComboMonth.Col[1].Combo.ComboGrid.Col[1].Width := FComboMonth.Width - FComboMonth.DefaultButtonWidth - 1;
    FComboMonth.Col[1].Combo.ComboGrid.DefaultRowHeight := TextHeight + 2;
    ...
    FComboMonth.Col[1].Combo.ComboGrid.Font := FCOmboMonth.Font;
...
begin
    ...
    FUpDownYear.Top := FPnlEditYear.Top;
    FUpDownYear.Height := FPnlEditYear.Height;
end;
...
procedure TtsDateTime.PositionTimeButtons(TxtOffset, AMPMWidth, AMPMOffset,
                                          ...
                                          ButIncrTop, ButDecrTop: Integer);
begin
    FUpDownHour.Height := ButHeight;
    FUpDownHour.Width  := ButWidth * 2 + 2;
    FUpDownHour.Top := ButIncrTop;
    FUpDownMin.Height := ButHeight;
    FUpDownMin.Width  := ButWidth * 2 + 2;
    FUpDownMin.Top := ButIncrTop;
    FUpDownSec.Height := ButHeight;
    FUpDownSec.Width  := ButWidth * 2 + 2;
    FUpDownSec.Top := ButIncrTop;
    FUpDownAMPM.Height := ButHeight;
    FUpDownAMPM.Width  := ButWidth * 2 + 2;
    FUpDownAMPM.Top := ButIncrTop;
    ...
    FUpDownHour.Left := FTxtHour.Left - TxtOffset + 1;
    FUpDownMin.Left  := FTxtMinute.Left - TxtOffset + 1;
    FUpDownSec.Left  := FTxtSeconds.Left - TxtOffset + 1;
    FUpDownAMPM.Left := FTxtAMPM.Left - TxtOffset + 1;
...
begin
    ...
    begin
        ...
        FUpDownAMPM.Visible := False;
    end
    else
    begin
        FUpDownAMPM.Visible := True;
    ...
    try
        ...
        begin
            ...
            begin
                ...
                FUpDownYear.Left := FDateGrid.Left + FDateGrid.Width - FUpDownYear.Width + 1;
            end
            else
            begin
                ...
                FButYearDecr.Left := FButYearIncr.Left;
                FPnlEditYear.Left := FButYearIncr.Left - FPnlEditYear.Width - 1;
                FUpDownYear.Left  := FPnlDate.Width - FUpDownYear.Width;
            end;
        end;
...
procedure TtsDateTime.SetTimeControl(Control : TEdit);
begin
...
procedure TtsDateTime.UpDownTimeClick(Sender: TObject; Button: TUDBtnType);
begin
    if (Sender = FUpDownHour) then
       SetTimeControl(FTxtHour)
    else if (Sender = FUpDownMin) then
       SetTimeControl(FTxtMinute)
    else if (Sender = FUpDownSec) then
       SetTimeControl(FTxtSeconds)
    else if (Sender = FUpDownAMPM) then
       SetTimeControl(FTxtAMPM);
...
procedure TtsDateTime.UpDownYearClick(Sender: TObject; Button: TUDBtnType);
begin
    if (Button = btPrev) then
       FSpinButton := dtsIncrYear
    else
...
begin
    ...
    else if (FSpinButton = dtsIncrHour) then
    begin
            IncHour;
            Delay := 100;
    end
    else if (FSpinButton = dtsDecrHour) then
    begin
            DecHour;
            Delay := 100;
    end
    else if (FSpinButton = dtsIncrMin) then
    begin
            IncMinutes;
            Delay := 50;
    end
    else if (FSpinButton = dtsDecrMin) then
    begin
            DecMinutes;
            Delay := 50;
    end;
...
procedure TtsDateTime.butOkMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  Close(True);
end;

procedure TtsDateTime.butCancelMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
 Close(False);
end;
